...
const Footer = () => {
    ...
    return (
        <footer className="max-w-[1200px] w-full min-h-[100px] mx-auto py-4 mt-16 border-t border-t-zinc-700">
            ...
            <div className="pt-4">
                <p className="text-gray-300 text-sm text-center">Developed by Jonash Gaña</p>
                <p className="text-gray-300 text-sm text-center">&copy; Copyright 2025, All rights reserved.</p>
            </div>
        </footer>
    )
}
