                        ...
                        <div className="w-full flex flex-col">
                            ...
                            <div className="pt-2 flex flex-col">
                                ...
                                {playlist.tracks.total === 0 ? (
                                    <span className="text-zinc-300 text-sm">By {playlist.owner.display_name}</span>
                                ) : (
                                    <span className="text-zinc-300 text-sm">{playlist.tracks.total} songs</span>
                                )}
                                <p className="text-zinc-400 pt-2 leading-4">{playlist.description}</p>
                            </div>
                        </div>
                    </SwiperSlide>
                ))}
